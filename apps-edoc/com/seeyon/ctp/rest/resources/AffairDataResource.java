    ...
    public FlipInfo getPendingList(@QueryParam("ticket") String ticket,
		...
		if(flipInfo != null && memberId != null){
			 ...
			 if (info != null) {
				 ...
				 if(flipInfo.getData()==null||flipInfo.getData().size()==0){
					 return flipInfo;
				 }
				 for(CtpAffair affair:(List<CtpAffair>)flipInfo.getData()){
					 String url="/collaboration/collaboration.do?method=summary&openFrom=listPending&affairId=" + affair.getId();
					 affairLink.put(affair.getId().toString(), SSOTicketBean.makeURLOfSSOTicket(ticket, url));
				 }
				 paramsLink.put("urllink", affairLink);
				 flipInfo.setParams(paramsLink);
				 return flipInfo;
			 }
		}
		return flipInfo;
	...
	public FlipInfo getPendingList(@QueryParam("ticket")String ticket,
		...
		TicketInfo info = SSOTicketBean.getTicketInfo(ticket);
		 if (info != null) {
			 Map<String,Object> paramsLink = new HashMap<String,Object>();
			 Map<String,Object> affairLink = new HashMap<String,Object>();
			 if(Strings.isEmpty(flipInfo.getData())){
				 return flipInfo;
			 }
			 for(CtpAffair affair:(List<CtpAffair>)flipInfo.getData()){
				 String url="/collaboration/collaboration.do?method=summary&openFrom=listPending&affairId=" + affair.getId();
	...
	public FlipInfo getDoneList(@QueryParam("ticket") String ticket,
		...
		if(memberId != null){
		 ...
		 if (info != null) {
			 ...
			 for(CtpAffair affair:(List<CtpAffair>)flipInfo.getData()){
				 String url="/collaboration/collaboration.do?method=summary&openFrom=listDone&affairId=" + affair.getId();
				 affairLink.put(affair.getId().toString(), SSOTicketBean.makeURLOfSSOTicket(ticket, url));
			 }
			 paramsLink.put("urllink", affairLink);
			 flipInfo.setParams(paramsLink);
	...
	public FlipInfo getDoneListByMemberCode(@QueryParam("ticket") String ticket,
		...
		TicketInfo info = SSOTicketBean.getTicketInfo(ticket);
		 if (info != null) {
			 Map<String,Object> paramsLink = new HashMap<String,Object>();
			 Map<String,Object> affairLink = new HashMap<String,Object>();
			 if(flipInfo.getData()==null||flipInfo.getData().isEmpty()){
				 return flipInfo;
			 }
			 for(CtpAffair affair:(List<CtpAffair>)flipInfo.getData()){
				 String url="/collaboration/collaboration.do?method=summary&openFrom=listDone&affairId=" + affair.getId();
	...
	public FlipInfo getSentList(@QueryParam("ticket") String ticket,
		...
		TicketInfo info = SSOTicketBean.getTicketInfo(ticket);
		 if (info != null) {
			 ...
			 for(CtpAffair affair:(List<CtpAffair>)flipInfo.getData()){
				 String url="/collaboration/collaboration.do?method=summary&openFrom=listSent&affairId=" + affair.getId();
				 affairLink.put(affair.getId().toString(), SSOTicketBean.makeURLOfSSOTicket(ticket, url));
			 }
			 paramsLink.put("urllink", affairLink);
			 flipInfo.setParams(paramsLink);
	...
	public FlipInfo getDraftList(@QueryParam("ticket") String ticket,
		...
		TicketInfo info = SSOTicketBean.getTicketInfo(ticket);
		 if (info != null) {
			 ...
			 for(CtpAffair affair:(List<CtpAffair>)flipInfo.getData()){
				 String url="/collaboration/collaboration.do?method=summary&openFrom=listWaitSend&affairId=" + affair.getId();
				 affairLink.put(affair.getId().toString(), SSOTicketBean.makeURLOfSSOTicket(ticket, url));
			 }
			 paramsLink.put("urllink", affairLink);
			 flipInfo.setParams(paramsLink);
		...
		TicketInfo info = SSOTicketBean.getTicketInfo(ticket);
		 if (info != null) {
			 ...
			 for(CtpAffair affair:(List<CtpAffair>)flipInfo.getData()){
				 ...
				 String url="/collaboration/collaboration.do?method=summary&openFrom=" + from + "&affairId=" + affair.getId();
				 affairLink.put(affair.getId().toString(), SSOTicketBean.makeURLOfSSOTicket(ticket, url));
			 }
			 paramsLink.put("urllink", affairLink);
			 flipInfo.setParams(paramsLink);
