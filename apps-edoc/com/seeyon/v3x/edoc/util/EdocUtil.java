	...
	public static String showDate(Date date){
		...
		if(nYear == cYear){
			if(cDate.equals(before)){
				returnDate = ResourceUtil.getString("edoc.date.yestoday") + Datetimes.format(date, "HH:mm");
			}else if(cDate.equals(now)){
				returnDate = ResourceUtil.getString("edoc.date.today") + Datetimes.format(date, "HH:mm");
			}else{
				returnDate = Datetimes.format(date, "MM-dd HH:mm");
			}
		}else{
			returnDate = Datetimes.format(date, "yyyy-MM-dd HH:mm");
		}
		return returnDate;
	}
}
