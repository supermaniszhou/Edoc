...
public class FormParseUtil {
     ...
     * zlc 扩展
     */
    public static boolean writeFormFileZlc(Long summaryId, String folder) {
        boolean ret = true;
        try {
            EdocSummary summary = getEdocSummary(summaryId);
            if (summary == null) {
            ...
            // 将文单写成HTML
            File contentFile = new File(summaryRoot + "/form.html");
            FileUtils.writeStringToFile(contentFile, extInfo.getContent().concat(stringCss()), "utf-8");
     ...
     * @return
     */
    public static String getHtmlContentZlc(Long summaryId, String folder) {
        String html = "";
        try {
            EdocSummary summary = getEdocSummary(summaryId);
            if (summary == null) {
            ...
            String fileFolder = "test";
            FormParseExtInfo extInfo = formatFormContent(summary, fileFolder);
            html = extInfo.getContent().concat(stringCss());
    ...
    public static String stringCss() {
        String css = "<style>@charset \"utf-8\";TABLE.xdLayout TD {\t\tBORDER-RIGHT: medium none;\t\tBORDER-TOP: medium none;\t\tBORDER-LEFT: medium none;\t\tBORDER-BOTTOM: medium none;\n" +
                "}TABLE {\t\tBEHAVIOR: url (#default#urn::tables/NDTable)}BODY{\t\t\tcolor:windowtext;\t\tbackground-color:#ffffff;\t\tlayout-grid:none;}strong input, strong select , strong textarea{\tfont-weight: bold;}body, td, th, input, textarea, div, select, p ,span{\tfont-family: SimSun,\"Microsoft YaHei\", Arial,Helvetica,sans-serif;}.xdTextBox{\n" +
                "\tdisplay:inline-block;\ttext-overflow:ellipsis;\tpadding-top:1px;\tpadding-bottom:1px;\tpadding-left:0px;\tpadding-right:0px;\tmargin:1px;\tborder: 1pt solid #dcdcdc;\tcolor:windowtext;\tbackground-color:window;\ttext-align:left;\twhite-space:normal;}</style>";
        return css;
    }
    ...
    private static FormParseExtInfo formatFormContent(EdocSummary summary, Long actorId, boolean toHTML, String tempFile, CtpAffair affair, boolean canSeeMyselfOpinion) throws BusinessException {
        ...
        if (toHTML) {
            ...
            htmlForm.append("<LINK rel=\"stylesheet\" type=\"text/css\"  href=\"" + tempFile + "/common/skin/dist/common/skin.css\"/>");
            ...
            extInfo.addFiles("common/skin/dist/common/skin.css");
