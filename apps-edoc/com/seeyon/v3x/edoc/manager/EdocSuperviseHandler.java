...
public class EdocSuperviseHandler implements SuperviseHandler{
        ...
        if(result != null && !result.isEmpty()){
            for(int i=0;i<result.size();i++){
               ...
               model.setCurrentNodesInfo(EdocHelper.parseCurrentNodesInfo(summary));
                ...
                model.setAppName(this.getAppName(edocType));
            	...
            	if (model.getAppName() != null && edocSummaryManager != null) {
					Map<String,String> defaultNodeMap = edocSummaryManager.getEdocDefaultNode(model.getAppName(),model.getFlowPermAccountId());
	...
	private String getAppName(int appType){
		String appName="edoc";
		 if(appType == 0){
