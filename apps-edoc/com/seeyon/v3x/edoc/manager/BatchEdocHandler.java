...
public class BatchEdocHandler extends BatchAppHandler {
	...
	@Override
	public List<String> checkAppPolicy(CtpAffair affair, Object object) throws BatchException, BusinessException {
	...
	private List<String> checkEdocPolicy(NodePolicy policy,EnumNameEnum edocTypeEnum ,long flowPermAccountId,String nodePermissionPolicy) throws BatchException{
