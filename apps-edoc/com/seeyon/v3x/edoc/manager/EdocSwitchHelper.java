...
public class EdocSwitchHelper {
	...
	{
		ConfigItem configItem=configManager.getConfigItem(IConfigPublicKey.EDOC_SWITCH_KEY, IConfigPublicKey.Allow_Update_Attachment,accountId);
		if(configItem==null)
		{
			configItem=configManager.getConfigItem(IConfigPublicKey.EDOC_SWITCH_KEY, IConfigPublicKey.Allow_Update_Attachment, ConfigItem.Default_Account_Id);
		}
		if(configItem==null){return true;}
		return "yes".equals(configItem.getConfigValue());
	}
...
//	}
	...
	{
		ConfigItem configItem=configManager.getConfigItem(IConfigPublicKey.EDOC_SWITCH_KEY, EDOC_SWITCH_taohongriqi,accountId);
		if(configItem==null)
		{
			configItem=configManager.getConfigItem(IConfigPublicKey.EDOC_SWITCH_KEY, EDOC_SWITCH_taohongriqi, ConfigItem.Default_Account_Id);
		}
		if(configItem==null){return true;}
		return "yes".equals(configItem.getConfigValue());
	}
