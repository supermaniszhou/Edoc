...
import com.seeyon.apps.collaboration.quartz.WorkflowNodeOvertimeAppHandler;
 ...
 *
 */
public class EdocNodeOverTimeManagerImpl extends WorkflowNodeOvertimeAppHandler{
    ...
    @Override
    public void transOverTimeProcessing(Long affairId, Long isAdvanceRemind) throws BusinessException {
                ...
                if(Long.valueOf(1).equals(isAdvanceRemind)){
                    ...
                    if(dealTermType != 0) {
                        ...
                        try {
                            ...
                            bpmProcess= wapi.getBPMProcessForM1(processId);
                            if(bpmProcess != null){
...
public void sendMsg(Long summaryId,Long opinionId,String commentCont) throws BusinessException {
       ...
       String opinionContent = MessageUtil.getComment4Message(Strings.toText(commentCont));
       try {
   ...
   private AffairData createEdocAffairData(EdocSummary summary,CtpAffair affair,User user) {
    ...
    public NodeAutoRunCaseBO canAutoRunCase(String matchRequestToken,Object object,CtpAffair affair,BPMSeeyonPolicy bpmSeeyonPolicy) throws BusinessException {
        ...
        String category = EdocEnum.edocType.sendEdoc.name();
        ...
        boolean isExchangeNode= wapi.isExchangeNode(category, affair.getNodePolicy(), flowPermAccout);
        ...
        if(isSepcial){
            ...
            if(!"inform".equals(affair.getNodePolicy()) && !"zhihui".equals(affair.getNodePolicy())) {
                ...
                if(isExecuteFinished){
                    ...
                    PopResult pr = isPop(matchRequestToken,WorkflowMatchLogMessageConstants.step5,affair, summary.getProcessId(), summary.getCaseId(),summary.getStartUserId(),null,null,"edoc");
